...
public interface UserApi {
    ...
    void createUser(@Valid UserDTO body) throws Exception;
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = Void.class) })
    void createUsersWithArrayInput(@Valid List<UserDTO> body) throws Exception;
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = Void.class) })
    void createUsersWithListInput(@Valid List<UserDTO> body) throws Exception;
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 400, message = "Invalid username supplied", response = Void.class),
        @ApiResponse(code = 404, message = "User not found", response = Void.class) })
    UserDTO getUserByName(@PathParam("username") @ApiParam("The name that needs to be fetched. Use user1 for testing. ") String username) throws Exception;
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 404, message = "User not found", response = Void.class) })
    void updateUser(@PathParam("username") @ApiParam("name that need to be updated") String username,@Valid UserDTO body) throws Exception;
}
