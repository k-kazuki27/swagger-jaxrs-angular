...
public interface PetApi {
    ...
    void addPet(@Valid PetDTO body) throws Exception;
    ...
    List<PetDTO> findPetsByStatus(@QueryParam("status") @NotNull @ApiParam("Status values that need to be considered for filter") List<String> status) throws Exception;
    ...
    List<PetDTO> findPetsByTags(@QueryParam("tags") @NotNull @ApiParam("Tags to filter by") List<String> tags) throws Exception;
    ...
    @ApiResponses(value = {
        ...
        ,
        @ApiResponse(code = 404, message = "Pet not found", response = Void.class)})
    PetDTO getPetById(@PathParam("petId") @ApiParam("ID of pet to return") Long petId) throws Exception;
    ...
    void updatePet(@Valid PetDTO body) throws Exception;
    ...
    ApiResponseDTO uploadFile(@PathParam("petId") @ApiParam("ID of pet to update") Long petId, @FormParam(value = "additionalMetadata") String additionalMetadata, @FormParam(value = "file") InputStream fileInputStream,
